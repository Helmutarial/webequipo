...
export default function LoginPage() {
  ...
  const submit = async (event: FormEvent) => { event.preventDefault(); const result = await login(email, password); if (result.ok) router.push("/admin"); else setError(result.message); };
